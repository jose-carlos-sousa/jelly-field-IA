...
class PlayerSelect(Screen):
    def __init__(self):
        ...
        self.add_text_button("Depth-First Search AI", "medium_bold", (100, 300), alignment="left")
        self.add_text_button("Breadth-First Search AI", "medium_bold", (100, 400), alignment="left")
        self.add_text_button("Greedy Maximize Empty AI", "medium_bold", (100, 500), alignment="left")
        self.add_text_button("Greedy Maximize Collapse AI", "medium_bold", (100, 600), alignment="left")
        self.add_text_button("Iterative Deepening AI", "medium_bold", (self.width - 100, 200), alignment="right")
        self.add_text_button("A* Maximize Empty AI", "medium_bold", (self.width - 100, 300), alignment="right")
        self.add_text_button("A* Minimize Goal AI", "medium_bold", (self.width - 100, 400), alignment="right")
        self.add_text_button("A* Maximize Collapse AI", "medium_bold", (self.width - 100, 500), alignment="right")
    ...
    def display(self, state):
        ...
        self.draw_button("Depth-First Search AI", "medium_bold", (100, 300), alignment="left")
        self.draw_button("Breadth-First Search AI", "medium_bold", (100, 400), alignment="left")
        self.draw_button("Greedy Maximize Empty AI", "medium_bold", (100, 500), alignment="left")
        self.draw_button("Greedy Maximize Collapse AI", "medium_bold", (100, 600), alignment="left")
        self.draw_button("Iterative Deepening AI", "medium_bold", (self.width - 100, 200), alignment="right")
        self.draw_button("A* Maximize Empty AI", "medium_bold", (self.width - 100, 300), alignment="right")
        self.draw_button("A* Minimize Goal AI", "medium_bold", (self.width - 100, 400), alignment="right")
        self.draw_button("A* Maximize Collapse AI", "medium_bold", (self.width - 100, 500), alignment="right")
                ...
                for button_text, rect in self.buttons.items():
                    if rect.collidepoint(event.pos):
                        ...
                        if button_text == "Human":
                            ...
                            return "ai_game", state
                        elif button_text == "A* Maximize Collapse AI":
                            state.player = "A* Maximize Collapse AI"
                            return "ai_game", state
                        elif button_text == "Greedy Maximize Collapse AI":
                            state.player = "Greedy Maximize Collapse AI"
                            return "ai_game", state
